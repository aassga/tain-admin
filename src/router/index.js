...
export const asyncRouterMap = [
...

  {
    path:'/analysis',
    component: Layout,
    redirect: '/analysis/analysisData',
    name: 'analysis',
    meta: {title: '活動分析', icon: 'ums'},
    children: [
      {
        path: 'analysisData',
        name: 'analysisData',
        component: () => import('@/views/analysis/analysisData/index'),
        meta: {title: '抽獎數據', icon: 'ums'}
      },
      {
        path: 'analysisTransform',
        name: 'analysisTransform',
        component: () => import('@/views/analysis/analysisTransform/index'),
        meta: {title: '觸及&轉換', icon: 'ums'}
      }
    ]
  },
  {
    path:'/prize',
    component: Layout,
    redirect: '/prize/prizeManage',
    name: 'prize',
    meta: {title: '活動獎池', icon: 'ums'},
    children: [
      {
        path: 'prizeManage',
        name: 'prizeManage',
        component: () => import('@/views/prize/prizeManage/index'),
        meta: {title: '抽獎數據', icon: 'ums'}
      }
    ]
  },
  {
    path:'/customer',
    component: Layout,
    redirect: '/customer/customerData',
    name: 'customer',
    meta: {title: '會員資料', icon: 'ums'},
    children: [
      {
        path: 'customerData',
        name: 'customerData',
        component: () => import('@/views/customer/customerData/index'),
        meta: {title: '所有會員', icon: 'ums'}
      },
      {
        path: 'customerWinner',
        name: 'customerWinner',
        component: () => import('@/views/customer/customerWinner/index'),
        meta: {title: '中獎會員', icon: 'ums'}
      }
    ]
  },
