  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productRelationTable"
        ...
        <el-table-column label="剩余數量" width="100" align="center">
        ...
        <el-table-column label="限购數量" width="100" align="center">
