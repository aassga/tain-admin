<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="商品名稱：">
            <el-input v-model="listQuery.productName" class="input-width" placeholder="商品名稱"></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>數據列表</span>
      <el-button size="mini" class="btn-add" @click="handleSelectProduct()">選擇商品</el-button>
    </el-card>
