<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="資源名稱：">
            <el-input v-model="listQuery.nameKeyword" class="input-width" placeholder="資源名稱" clearable></el-input>
          </el-form-item>
          <el-form-item label="資源路徑：">
            <el-input v-model="listQuery.urlKeyword" class="input-width" placeholder="資源路徑" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleShowCategory()">資源分類</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="resourceTable"
        ...
        <el-table-column label="資源名稱" align="center">
          <template slot-scope="scope">{{scope.row.name}}</template>
        </el-table-column>
        <el-table-column label="資源路徑" align="center">
