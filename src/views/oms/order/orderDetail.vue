  ...
  <div class="detail-container">
    <div>
      <el-steps :active="formatStepStatus(order.status)" finish-status="success" align-center>
        ...
        <el-step title="完成评價" :description="formatTime(order.commentTime)"></el-step>
      </el-steps>
    </div>
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        <i class="el-icon-warning color-danger" style="margin-left: 20px"></i>
        <span class="color-danger">当前訂單狀態：{{order.status | formatStatus}}</span>
        <div class="operate-button-container" v-show="order.status===0">
          <el-button size="mini" @click="showUpdateReceiverDialog">修改收貨人訊息</el-button>
          <el-button size="mini">修改商品訊息</el-button>
          <el-button size="mini" @click="showUpdateMoneyDialog">修改费用訊息</el-button>
          <el-button size="mini" @click="showMessageDialog">發送站内信</el-button>
        ...
        <div class="operate-button-container" v-show="order.status===2||order.status===3">
          <el-button size="mini" @click="showLogisticsDialog">訂單跟踪</el-button>
          <el-button size="mini" @click="showMessageDialog">發送站内信</el-button>
          <el-button size="mini" @click="showMarkOrderDialog">備註訂單</el-button>
        </div>
      ...
      <div style="margin-top: 20px">
        ...
        <span class="font-small">基本訊息</span>
      </div>
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">訂單来源</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">訂單可得優币</el-col>
          <el-col :span="4" class="table-cell-title">訂單可得成長值</el-col>
          <el-col :span="4" class="table-cell-title">活動訊息</el-col>
        </el-row>
        <el-row>
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">收貨人訊息</span>
      </div>
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">收貨人</el-col>
          <el-col :span="6" class="table-cell-title">手机號碼</el-col>
          <el-col :span="6" class="table-cell-title">邮政編碼</el-col>
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">商品訊息</span>
      </div>
      <el-table
        ref="orderItemTable"
      ...
      <div style="margin-top: 60px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">费用訊息</span>
      </div>
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">商品合計</el-col>
          <el-col :span="6" class="table-cell-title">運费</el-col>
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">操作訊息</span>
      </div>
