<template>
  <div class="detail-container">
    ...
    <el-card shadow="never" class="standard-margin">
      <span class="font-title-medium">服務單訊息</span>
      <div class="form-container-border">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">聯繫電话</el-col>
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0">
        ...
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">拒绝退貨</el-button>
      </div>
