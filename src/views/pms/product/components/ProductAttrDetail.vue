<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="规格参數：">
        <el-tabs v-model="activeHtmlName" type="card">
          <el-tab-pane label="電脑端詳情" name="pc">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，填写商品促銷</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      handleRefreshProductSkuList() {
        this.$confirm('刷新列表將導致sku訊息重新生成，是否要刷新', '提示', {
