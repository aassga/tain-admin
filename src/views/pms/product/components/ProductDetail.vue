<template> 
  <el-card class="form-container" shadow="never">
    <el-steps :active="active" finish-status="success" align-center>
      <el-step title="填写商品訊息"></el-step>
      <el-step title="填写商品促銷"></el-step>
      <el-step title="填写商品屬性"></el-step>
...
<script>
  ...
  const defaultProductParam = {
    ...
    //商品sku庫存訊息{lowStock: 0, pic: '', price: 0, sale: 0, skuCode: '', spData: '', stock: 0}
    skuStockList: [],
    //商品相關專題{subjectId: 0}
